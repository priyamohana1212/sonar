...
import ecommerce.utils.AwsStorageService;
...
//	private StorageService storageService;
	...
	@Override
	public void addProduct(Product p,List<MultipartFile> files) {
		// TODO Auto-generated method stub
		String photo=awsStorageService.uploadFile(files.get(0));
		p.setPhoto(photo);
		dao.save(p);
	}
	...
	public void deleteProduct(int prodid) {
		...
		awsStorageService.deleteFile(p.getPhoto());
		dao.delete(p);
	}
